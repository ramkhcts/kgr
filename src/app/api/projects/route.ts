  ...
  try {
    ...
    const project = await prisma.project.create({
      data: {
        ...
        technicalContactName:   body.technicalContactName || null,
        technicalContactEmail:  body.technicalContactEmail || null,
        procurementContactName: body.procurementContactName || null,
        procurementContactEmail: body.procurementContactEmail || null,
        msaReference:           body.msaReference || null,
        serviceTier:            body.serviceTier || null,
        transitionPeriodWeeks:  body.transitionPeriodWeeks != null ? parseInt(body.transitionPeriodWeeks) : null,
        transitionNotes:        body.transitionNotes || null,
        incumbentContractExpiry: body.incumbentContractExpiry ? new Date(body.incumbentContractExpiry) : null,
        incumbentCooperative:   body.incumbentCooperative != null ? Boolean(body.incumbentCooperative) : null,
      },
